    ...
    def runMobileCode(self, cookie, code):
        ...
        try:
            with open(tempfile,"w+") as f:
                f.write(code)
            p = subprocess.Popen(["python3 ~/NetSec_TeamProject/netsec_fall2017/lab4/sandbox/sandbox/pypy/sandbox/pypy_interact.py --tmp=NetSec_TeamProject/netsec_fall2017/lab4/sandbox/sandbox/pypy/sandbox/tmp ~/NetSec_TeamProject/netsec_fall2017/lab4/sandbox/sandbox/pypy/sandbox/pypy3-c-sandbox -S ", f.name], stdout=subtrocess.PIPE, stderr=subprocess.STDOUT)
